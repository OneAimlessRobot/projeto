 ...
 * 
 */
class OrderedDoubleListIterator<K,V> implements TwoWayIterator<Entry<K,V>>
{
     ...
     */
    protected DoubleListNode<Entry<K,V>> firstNode;

    /**
     * Node with the last element in the iteration.
     */
    protected DoubleListNode<Entry<K,V>> lastNode;
     ...
     */
    public OrderedDoubleListIterator( DoubleListNode<Entry<K,V>> first, DoubleListNode<Entry<K,V>> last )
    {
        firstNode = first;
        lastNode = last;
        this.rewind();
